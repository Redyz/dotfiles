...
" Generated by http://bytefluent.com/vivify 2014-02-25
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Identifier guifg=#00c20a guibg=NONE guisp=NONE gui=bold ctermfg=34 ctermbg=NONE cterm=bold
...
hi Normal guifg=#609175 guibg=#002b36 guisp=#002b36 gui=NONE ctermfg=65 ctermbg=23 cterm=NONE
...
hi Function guifg=#208000 guibg=NONE guisp=NONE gui=bold ctermfg=2 ctermbg=NONE cterm=bold
